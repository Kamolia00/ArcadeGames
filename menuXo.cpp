...
Rectangle exit_btn={490,450,300,60};
 ...
 DrawText("Arcade Games",500,140,40,WHITE);
        ...
        DrawText("Play PvP",500,250,20,WHITE);
        DrawRectangleRec(ai_btn,DARKBLUE);
        DrawText("Play AI",500,350,20,WHITE);
        DrawRectangleRec(exit_btn,DARKBLUE);
        DrawText("Exit",500,450,20,WHITE);
        EndDrawing();
    }
}
int showAiMenu(){
    ...
    // wait one frame to clear mouse state from previous menu
    BeginDrawing();
    EndDrawing();
